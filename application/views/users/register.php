...
<?php echo form_open('users/register'); ?>
			...
			<input type="text" class="form-control" name="zipcode" placeholder="Zipcode" aria-describedby="basic-addon1">
			</span>
			</div><br>
			<div class="form-group">
				<span class="input-group-text" id="basic-addon1">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control" name="password2" placeholder="Confirm Password" aria-describedby="basic-addon1">
				</span>
			</div><br>
